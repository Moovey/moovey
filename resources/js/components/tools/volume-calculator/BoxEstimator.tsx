...
export default function BoxEstimator({ roomName, boxCount, onBoxCountChange }: BoxEstimatorProps) {
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="flex-1">
                    <h5 className="text-sm sm:text-base font-semibold text-gray-800 mb-1">
                        📦 Box Estimate for {roomName}
                    </h5>
                    <p className="text-xs sm:text-sm text-gray-600">
                        How many moving boxes do you estimate for this room?
                    </p>
                    {boxCount > 0 && (
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-500 mt-1 italic">
                        💡 Tip: Most people underestimate. Small items, clothes, and kitchenware often need more boxes than expected.
                    </p>
                </div>
