...
export default function BusinessSettings({ auth }: Props) {
  ...
  const { data: passwordData, setData: setPasswordData, put: putPassword, errors: passwordErrors, processing: processingPassword, recentlySuccessful: recentlySuccessfulPassword, reset: resetPassword } = useForm({
    current_password: '',
    password: '',
      ...
      <div className="bg-gradient-to-r from-[#1A237E] to-[#3F51B5] text-white rounded-xl p-8 mb-8 shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-lg opacity-90">Manage your account</p>
          </div>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form onSubmit={updateProfile} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <Button disabled={processingProfile} className="bg-[#1A237E] hover:bg-[#303F9F] text-white px-6 py-2">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form onSubmit={updatePassword} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <Button disabled={processingPassword} className="bg-[#1A237E] hover:bg-[#303F9F] text-white px-6 py-2">
